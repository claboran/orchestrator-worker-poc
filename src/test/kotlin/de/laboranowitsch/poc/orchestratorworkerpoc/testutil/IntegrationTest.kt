...
/**
 * Custom annotation for full integration tests with both PostgreSQL and ElasticMQ.
 * This replaces the need to extend BaseIntegrationTest and provides automatic configuration
...
/**
 * Base class for full integration tests providing both PostgreSQL and ElasticMQ containers.
...
abstract class IntegrationTestContainers {
    companion object {
        ...
        fun configureProperties(registry: DynamicPropertyRegistry) {
            // Configure ElasticMQ properties using the existing helper
